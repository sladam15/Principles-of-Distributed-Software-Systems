      ...
      if (request == null) {
		...
		try {
          ...
          // a response that makes sense		  
			  ...
			  builder.append("Content-Type: text/html; charset=utf-8\n");
			  builder.append("\n");
			  builder.append("Need two integer values to multiply");
		  }
		...
		try {
		  ...
		  JSONObject obj = new JSONObject("{\"owner_name\": \"amehlhase316\"}");
		  JSONObject obj2 = new JSONObject("{\"id\": \"164481338\"}");
		  JSONObject obj3 = new JSONObject("{\"name\": \"memoranda\"}");
		  
		  builder.append("HTTP/1.1 200 OK\n");
		  builder.append("Content-Type: text/html; charset=utf-8\n");
		  builder.append("\n");		  
		  builder.append(obj.getString("owner_name") + "," + obj2.getString("id") + " - >" + obj3.getString("name"));
		

		  JSONObject obj4 = new JSONObject("{\"owner_name\": \"amehlhase316\"}");
		  JSONObject obj5 = new JSONObject("{\"id\": \"298682891 \"}");
		  JSONObject obj6 = new JSONObject("{\"name\": \"ser321examples \"}");
		  System.out.println(obj4.getString("owner_name") + "," + obj5.getString("id") + " - >" + obj6.getString("name")); 
		   
		  builder.append(obj4.getString("owner_name") + "," + obj5.getString("id") + " - >" + obj6.getString("name")); 
		  
		  JSONObject obj7 = new JSONObject("{\"owner_name\": \"amehlhase316\"}");
		  JSONObject obj8 = new JSONObject("{\"id\": \"329421175 \"}");
		  JSONObject obj9 = new JSONObject("{\"name\": \"testing123 \"}");
		  System.out.println(obj7.getString("owner_name") + "," + obj8.getString("id") + " - >" + obj9.getString("name")); 
		   
		  builder.append(obj4.getString("owner_name") + "," + obj5.getString("id") + " - >" + obj6.getString("name")); 
		  
		  JSONObject obj10 = new JSONObject("{\"owner_name\": \"amehlhase316\"}");
		  JSONObject obj11 = new JSONObject("{\"id\": \"202576326 \"}");
		  JSONObject obj12 = new JSONObject("{\"name\": \"testing316 \"}");
		  System.out.println(obj4.getString("owner_name") + "," + obj5.getString("id") + " - >" + obj6.getString("name")); 
		   
		  builder.append(obj10.getString("owner_name") + "," + obj11.getString("id") + " - >" + obj12.getString("name"));
			  ...
			  builder.append("Content-Type: text/html; charset=utf-8\n");
			  builder.append("\n");
			  builder.append("No such repo exists");
		  }
		...
		try {
          ...
          builder.append("Result is: " + result);
			  ...
			  builder.append("Content-Type: text/html; charset=utf-8\n");
			  builder.append("\n");
			  builder.append("Need two integer values to add");
		  }

		// SECOND ADDED REQUEST
		// Else-if which will perform a subtration equation (num1 -num2) in the browser
		// with given parameters. Error handling will account for not enough
		// integers.
		...
		try {
          ...
          builder.append("Result is: " + result);
			  ...
			  builder.append("Content-Type: text/html; charset=utf-8\n");
			  builder.append("\n");
			  builder.append("Need two integer values to subtract");
		  }
