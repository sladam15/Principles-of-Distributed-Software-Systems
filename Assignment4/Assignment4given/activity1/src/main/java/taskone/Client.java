...
public class Client {
    ...
    public static JSONObject pop() {
		...
		try {
            System.out.print("Please input the element to remove: ");
            strToSend = stdin.readLine();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static JSONObject switching() {
        ...
        System.out.print("Please input the index to reverse: ");
        try {
            strToSend = stdin.readLine();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            do {
                ...
                System.out.println("3. display - display the current list");
                System.out.println("4. count - returns the elements in the list and displays the number");
                System.out.println("5. reverse <int> - reverses the String at given index and displays new list");
